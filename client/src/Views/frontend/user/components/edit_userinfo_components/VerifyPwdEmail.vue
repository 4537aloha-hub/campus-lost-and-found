d:\campus-lost-and-found\client\src\Views\frontend\user\components\edit_userinfo_components\VerifyPwdEmail.vue
<script setup>
...
<template>
  <div class="container">
    <div class="set-email">
      ...
      <div class="common-flow-info">当前你正在修改密码, 请先验证邮箱</div>
